...
}`;function a_(i,e,t){let n=new Sl;const s=new lt,o=new lt,u=new nn,c=new n_({depthPacking:Zh}),d=new i_,p={},_=t.maxTextureSize,M={[Xi]:Pn,[Pn]:Xi,[ti]:ti},S=new qi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new lt},radius:{value:4}},vertexShader:r_,fragmentShader:s_}),b=S.clone();b.defines.HORIZONTAL_PASS=1;const C=new jt;C.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new vn(C,S),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ou;let g=this.type;this.render=function(H,G,X){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||H.length===0)return;const N=i.getRenderTarget(),I=i.getActiveCubeFace(),W=i.getActiveMipmapLevel(),ue=i.state;ue.setBlending(Hi),ue.buffers.color.setClear(1,1,1,1),ue.buffers.depth.setTest(!0),ue.setScissorTest(!1);const ee=g!==yi&&this.type===yi,se=g===yi&&this.type!==yi;for(let we=0,he=H.length;we<he;we++){const Me=H[we],fe=Me.shadow;if(fe===void 0){console.warn("THREE.WebGLShadowMap:",Me,"has no shadow.");continue}if(fe.autoUpdate===!1&&fe.needsUpdate===!1)continue;s.copy(fe.mapSize);const ve=fe.getFrameExtents();if(s.multiply(ve),o.copy(fe.mapSize),(s.x>_||s.y>_)&&(s.x>_&&(o.x=Math.floor(_/ve.x),s.x=o.x*ve.x,fe.mapSize.x=o.x),s.y>_&&(o.y=Math.floor(_/ve.y),s.y=o.y*ve.y,fe.mapSize.y=o.y)),fe.map===null||ee===!0||se===!0){const Je=this.type!==yi?{minFilter:ii,magFilter:ii}:{};fe.map!==null&&fe.map.dispose(),fe.map=new ur(s.x,s.y,Je),fe.map.texture.name=Me.name+".shadowMap",fe.camera.updateProjectionMatrix()}i.setRenderTarget(fe.map),i.clear();const He=fe.getViewportCount();for(let Je=0;Je<He;Je++){const de=fe.getViewport(Je);u.set(o.x*de.x,o.y*de.y,o.x*de.z,o.y*de.w),ue.viewport(u),fe.updateMatrices(Me,Je),n=fe.getFrustum(),A(G,X,fe.camera,Me,this.type)}fe.isPointLightShadow!==!0&&this.type===yi&&k(fe,X),fe.needsUpdate=!1}g=this.type,x.needsUpdate=!1,i.setRenderTarget(N,I,W)};function k(H,G){const X=e.update(T);S.defines.VSM_SAMPLES!==H.blurSamples&&(S.defines.VSM_SAMPLES=H.blurSamples,b.defines.VSM_SAMPLES=H.blurSamples,S.needsUpdate=!0,b.needsUpdate=!0),H.mapPass===null&&(H.mapPass=new ur(s.x,s.y)),S.uniforms.shadow_pass.value=H.map.texture,S.uniforms.resolution.value=H.mapSize,S.uniforms.radius.value=H.radius,i.setRenderTarget(H.mapPass),i.clear(),i.renderBufferDirect(G,null,X,S,T,null),b.uniforms.shadow_pass.value=H.mapPass.texture,b.uniforms.resolution.value=H.mapSize,b.uniforms.radius.value=H.radius,i.setRenderTarget(H.map),i.clear(),i.renderBufferDirect(G,null,X,b,T,null)}function F(H,G,X,N){let I=null;const W=X.isPointLight===!0?H.customDistanceMaterial:H.customDepthMaterial;if(W!==void 0)I=W;else if(I=X.isPointLight===!0?d:c,i.localClippingEnabled&&G.clipShadows===!0&&Array.isArray(G.clippingPlanes)&&G.clippingPlanes.length!==0||G.displacementMap&&G.displacementScale!==0||G.alphaMap&&G.alphaTest>0||G.map&&G.alphaTest>0){const ue=I.uuid,ee=G.uuid;let se=p[ue];se===void 0&&(se={},p[ue]=se);let we=se[ee];we===void 0&&(we=I.clone(),se[ee]=we,G.addEventListener("dispose",$)),I=we}if(I.visible=G.visible,I.wireframe=G.wireframe,N===yi?I.side=G.shadowSide!==null?G.shadowSide:G.side:I.side=G.shadowSide!==null?G.shadowSide:M[G.side],I.alphaMap=G.alphaMap,I.alphaTest=G.alphaTest,I.map=G.map,I.clipShadows=G.clipShadows,I.clippingPlanes=G.clippingPlanes,I.clipIntersection=G.clipIntersection,I.displacementMap=G.displacementMap,I.displacementScale=G.displacementScale,I.displacementBias=G.displacementBias,I.wireframeLinewidth=G.wireframeLinewidth,I.linewidth=G.linewidth,X.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const ue=i.properties.get(I);ue.light=X}return I}function A(H,G,X,N,I){if(H.visible===!1)return;if(H.layers.test(G.layers)&&(H.isMesh||H.isLine||H.isPoints)&&(H.castShadow||H.receiveShadow&&I===yi)&&(!H.frustumCulled||n.intersectsObject(H))){H.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,H.matrixWorld);const ee=e.update(H),se=H.material;if(Array.isArray(se)){const we=ee.groups;for(let he=0,Me=we.length;he<Me;he++){const fe=we[he],ve=se[fe.materialIndex];if(ve&&ve.visible){const He=F(H,ve,N,I);H.onBeforeShadow(i,H,G,X,ee,He,fe),i.renderBufferDirect(X,null,ee,He,H,fe),H.onAfterShadow(i,H,G,X,ee,He,fe)}}}else if(se.visible){const we=F(H,se,N,I);H.onBeforeShadow(i,H,G,X,ee,we,null),i.renderBufferDirect(X,null,ee,we,H,null),H.onAfterShadow(i,H,G,X,ee,we,null)}}const ue=H.children;for(let ee=0,se=ue.length;ee<se;ee++)A(ue[ee],G,X,N,I)}function $(H){H.target.removeEventListener("dispose",$);for(const X in p){const N=p[X],I=H.target.uuid;I in N&&(N[I].dispose(),delete N[I])}}}const o_={[bo]:wo,[Eo]:Co,[To]:Ro,[Xr]:Ao,[wo]:bo,[Co]:Eo,[Ro]:To,[Ao]:Xr};function l_(i,e){function t(){let Q=!1;const Ie=new nn;let pe=null;const ge=new nn(0,0,0,0);return{setMask:function(v){pe!==v&&!Q&&(i.colorMask(v,v,v,v),pe=v)},setLocked:function(v){Q=v},setClear:function(v,Se,ft,Ut,It){It===!0&&(v*=Ut,Se*=Ut,ft*=Ut),Ie.set(v,Se,ft,Ut),ge.equals(Ie)===!1&&(i.clearColor(v,Se,ft,Ut),ge.copy(Ie))},reset:function(){Q=!1,pe=null,ge.set(-1,0,0,0)}}}function n(){let Q=!1,Ie=!1,pe=null,ge=null,v=null;return{setReversed:function(Se){if(Ie!==Se){const ft=e.get("EXT_clip_control");Ie?ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.ZERO_TO_ONE_EXT):ft.clipControlEXT(ft.LOWER_LEFT_EXT,ft.NEGATIVE_ONE_TO_ONE_EXT);const Ut=v;v=null,this.setClear(Ut)}Ie=Se},getReversed:function(){return Ie},setTest:function(Se){Se?De(i.DEPTH_TEST):ke(i.DEPTH_TEST)},setMask:function(Se){pe!==Se&&!Q&&(i.depthMask(Se),pe=Se)},setFunc:function(Se){if(Ie&&(Se=o_[Se]),ge!==Se){switch(Se){case bo:i.depthFunc(i.NEVER);break;case wo:i.depthFunc(i.ALWAYS);break;case Eo:i.depthFunc(i.LESS);break;case Xr:i.depthFunc(i.LEQUAL);break;case To:i.depthFunc(i.EQUAL);break;case Ao:i.depthFunc(i.GEQUAL);break;case Co:i.depthFunc(i.GREATER);break;case Ro:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=Se}},setLocked:function(Se){Q=Se},setClear:function(Se){v!==Se&&(Ie&&(Se=1-Se),i.clearDepth(Se),v=Se)},reset:function(){Q=!1,pe=null,ge=null,v=null,Ie=!1}}}function s(){let Q=!1,Ie=null,pe=null,ge=null,v=null,Se=null,ft=null,Ut=null,It=null;return{setTest:function(Lt){Q||(Lt?De(i.STENCIL_TEST):ke(i.STENCIL_TEST))},setMask:function(Lt){Ie!==Lt&&!Q&&(i.stencilMask(Lt),Ie=Lt)},setFunc:function(Lt,Y,qe){(pe!==Lt||ge!==Y||v!==qe)&&(i.stencilFunc(Lt,Y,qe),pe=Lt,ge=Y,v=qe)},setOp:function(Lt,Y,qe){(Se!==Lt||ft!==Y||Ut!==qe)&&(i.stencilOp(Lt,Y,qe),Se=Lt,ft=Y,Ut=qe)},setLocked:function(Lt){Q=Lt},setClear:function(Lt){It!==Lt&&(i.clearStencil(Lt),It=Lt)},reset:function(){Q=!1,Ie=null,pe=null,ge=null,v=null,Se=null,ft=null,Ut=null,It=null}}}const o=new t,u=new n,c=new s,d=new WeakMap,p=new WeakMap;let _={},M={},S=new WeakMap,b=[],C=null,T=!1,x=null,g=null,k=null,F=null,A=null,$=null,H=null,G=new Et(0,0,0),X=0,N=!1,I=null,W=null,ue=null,ee=null,se=null;const we=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let he=!1,Me=0;const fe=i.getParameter(i.VERSION);fe.indexOf("WebGL")!==-1?(Me=parseFloat(/^WebGL (\d)/.exec(fe)[1]),he=Me>=1):fe.indexOf("OpenGL ES")!==-1&&(Me=parseFloat(/^OpenGL ES (\d)/.exec(fe)[1]),he=Me>=2);let ve=null,He={};const Je=i.getParameter(i.SCISSOR_BOX),de=i.getParameter(i.VIEWPORT),Ze=new nn().fromArray(Je),me=new nn().fromArray(de);function oe(Q,Ie,pe,ge){const v=new Uint8Array(4),Se=i.createTexture();i.bindTexture(Q,Se),i.texParameteri(Q,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(Q,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ft=0;ft<pe;ft++)Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?i.texImage3D(Ie,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,v):i.texImage2D(Ie+ft,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,v);return Se}const Le={};Le[i.TEXTURE_2D]=oe(i.TEXTURE_2D,i.TEXTURE_2D,1),Le[i.TEXTURE_CUBE_MAP]=oe(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Le[i.TEXTURE_2D_ARRAY]=oe(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Le[i.TEXTURE_3D]=oe(i.TEXTURE_3D,i.TEXTURE_3D,1,1),o.setClear(0,0,0,1),u.setClear(1),c.setClear(0),De(i.DEPTH_TEST),u.setFunc(Xr),xt(!1),yt(Nl),De(i.CULL_FACE),j(Hi);function De(Q){_[Q]!==!0&&(i.enable(Q),_[Q]=!0)}function ke(Q){_[Q]!==!1&&(i.disable(Q),_[Q]=!1)}function Ge(Q,Ie){return M[Q]!==Ie?(i.bindFramebuffer(Q,Ie),M[Q]=Ie,Q===i.DRAW_FRAMEBUFFER&&(M[i.FRAMEBUFFER]=Ie),Q===i.FRAMEBUFFER&&(M[i.DRAW_FRAMEBUFFER]=Ie),!0):!1}function et(Q,Ie){let pe=b,ge=!1;if(Q){pe=S.get(Ie),pe===void 0&&(pe=[],S.set(Ie,pe));const v=Q.textures;if(pe.length!==v.length||pe[0]!==i.COLOR_ATTACHMENT0){for(let Se=0,ft=v.length;Se<ft;Se++)pe[Se]=i.COLOR_ATTACHMENT0+Se;pe.length=v.length,ge=!0}}else pe[0]!==i.BACK&&(pe[0]=i.BACK,ge=!0);ge&&i.drawBuffers(pe)}function Dt(Q){return C!==Q?(i.useProgram(Q),C=Q,!0):!1}const Tt={[rr]:i.FUNC_ADD,[bh]:i.FUNC_SUBTRACT,[wh]:i.FUNC_REVERSE_SUBTRACT};Tt[Eh]=i.MIN,Tt[Th]=i.MAX;const qt={[Ah]:i.ZERO,[Ch]:i.ONE,[Rh]:i.SRC_COLOR,[So]:i.SRC_ALPHA,[Nh]:i.SRC_ALPHA_SATURATE,[Uh]:i.DST_COLOR,[Lh]:i.DST_ALPHA,[Ph]:i.ONE_MINUS_SRC_COLOR,[yo]:i.ONE_MINUS_SRC_ALPHA,[Ih]:i.ONE_MINUS_DST_COLOR,[Dh]:i.ONE_MINUS_DST_ALPHA,[Fh]:i.CONSTANT_COLOR,[Oh]:i.ONE_MINUS_CONSTANT_COLOR,[Bh]:i.CONSTANT_ALPHA,[zh]:i.ONE_MINUS_CONSTANT_ALPHA};function j(Q,Ie,pe,ge,v,Se,ft,Ut,It,Lt){if(Q===Hi){T===!0&&(ke(i.BLEND),T=!1);return}if(T===!1&&(De(i.BLEND),T=!0),Q!==yh){if(Q!==x||Lt!==N){if((g!==rr||A!==rr)&&(i.blendEquation(i.FUNC_ADD),g=rr,A=rr),Lt)switch(Q){case Hr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fl:i.blendFunc(i.ONE,i.ONE);break;case Ol:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Bl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",Q);break}else switch(Q){case Hr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fl:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Ol:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Bl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",Q);break}k=null,F=null,$=null,H=null,G.set(0,0,0),X=0,x=Q,N=Lt}return}v=v||Ie,Se=Se||pe,ft=ft||ge,(Ie!==g||v!==A)&&(i.blendEquationSeparate(Tt[Ie],Tt[v]),g=Ie,A=v),(pe!==k||ge!==F||Se!==$||ft!==H)&&(i.blendFuncSeparate(qt[pe],qt[ge],qt[Se],qt[ft]),k=pe,F=ge,$=Se,H=ft),(Ut.equals(G)===!1||It!==X)&&(i.blendColor(Ut.r,Ut.g,Ut.b,It),G.copy(Ut),X=It),x=Q,N=!1}function Yt(Q,Ie){Q.side===ti?ke(i.CULL_FACE):De(i.CULL_FACE);let pe=Q.side===Pn;Ie&&(pe=!pe),xt(pe),Q.blending===Hr&&Q.transparent===!1?j(Hi):j(Q.blending,Q.blendEquation,Q.blendSrc,Q.blendDst,Q.blendEquationAlpha,Q.blendSrcAlpha,Q.blendDstAlpha,Q.blendColor,Q.blendAlpha,Q.premultipliedAlpha),u.setFunc(Q.depthFunc),u.setTest(Q.depthTest),u.setMask(Q.depthWrite),o.setMask(Q.colorWrite);const ge=Q.stencilWrite;c.setTest(ge),ge&&(c.setMask(Q.stencilWriteMask),c.setFunc(Q.stencilFunc,Q.stencilRef,Q.stencilFuncMask),c.setOp(Q.stencilFail,Q.stencilZFail,Q.stencilZPass)),Bt(Q.polygonOffset,Q.polygonOffsetFactor,Q.polygonOffsetUnits),Q.alphaToCoverage===!0?De(i.SAMPLE_ALPHA_TO_COVERAGE):ke(i.SAMPLE_ALPHA_TO_COVERAGE)}function xt(Q){I!==Q&&(Q?i.frontFace(i.CW):i.frontFace(i.CCW),I=Q)}function yt(Q){Q!==xh?(De(i.CULL_FACE),Q!==W&&(Q===Nl?i.cullFace(i.BACK):Q===Mh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ke(i.CULL_FACE),W=Q}function tt(Q){Q!==ue&&(he&&i.lineWidth(Q),ue=Q)}function Bt(Q,Ie,pe){Q?(De(i.POLYGON_OFFSET_FILL),(ee!==Ie||se!==pe)&&(i.polygonOffset(Ie,pe),ee=Ie,se=pe)):ke(i.POLYGON_OFFSET_FILL)}function it(Q){Q?De(i.SCISSOR_TEST):ke(i.SCISSOR_TEST)}function z(Q){Q===void 0&&(Q=i.TEXTURE0+we-1),ve!==Q&&(i.activeTexture(Q),ve=Q)}function D(Q,Ie,pe){pe===void 0&&(ve===null?pe=i.TEXTURE0+we-1:pe=ve);let ge=He[pe];ge===void 0&&(ge={type:void 0,texture:void 0},He[pe]=ge),(ge.type!==Q||ge.texture!==Ie)&&(ve!==pe&&(i.activeTexture(pe),ve=pe),i.bindTexture(Q,Ie||Le[Q]),ge.type=Q,ge.texture=Ie)}function re(){const Q=He[ve];Q!==void 0&&Q.type!==void 0&&(i.bindTexture(Q.type,null),Q.type=void 0,Q.texture=void 0)}function be(){try{i.compressedTexImage2D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Ee(){try{i.compressedTexImage3D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function xe(){try{i.texSubImage2D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function je(){try{i.texSubImage3D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Fe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Be(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function _t(){try{i.texStorage2D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Ae(){try{i.texStorage3D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Ve(){try{i.texImage2D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function nt(){try{i.texImage3D.apply(i,arguments)}catch(Q){console.error("THREE.WebGLState:",Q)}}function Ue(Q){Ze.equals(Q)===!1&&(i.scissor(Q.x,Q.y,Q.z,Q.w),Ze.copy(Q))}function We(Q){me.equals(Q)===!1&&(i.viewport(Q.x,Q.y,Q.z,Q.w),me.copy(Q))}function rt(Q,Ie){let pe=p.get(Ie);pe===void 0&&(pe=new WeakMap,p.set(Ie,pe));let ge=pe.get(Q);ge===void 0&&(ge=i.getUniformBlockIndex(Ie,Q.name),pe.set(Q,ge))}function ut(Q,Ie){const ge=p.get(Ie).get(Q);d.get(Ie)!==ge&&(i.uniformBlockBinding(Ie,ge,Q.__bindingPointIndex),d.set(Ie,ge))}function Ct(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),u.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),_={},ve=null,He={},M={},S=new WeakMap,b=[],C=null,T=!1,x=null,g=null,k=null,F=null,A=null,$=null,H=null,G=new Et(0,0,0),X=0,N=!1,I=null,W=null,ue=null,ee=null,se=null,Ze.set(0,0,i.canvas.width,i.canvas.height),me.set(0,0,i.canvas.width,i.canvas.height),o.reset(),u.reset(),c.reset()}return{buffers:{color:o,depth:u,stencil:c},enable:De,disable:ke,bindFramebuffer:Ge,drawBuffers:et,useProgram:Dt,setBlending:j,setMaterial:Yt,setFlipSided:xt,setCullFace:yt,setLineWidth:tt,setPolygonOffset:Bt,setScissorTest:it,activeTexture:z,bindTexture:D,unbindTexture:re,compressedTexImage2D:be,compressedTexImage3D:Ee,texImage2D:Ve,texImage3D:nt,updateUBOMapping:rt,uniformBlockBinding:ut,texStorage2D:_t,texStorage3D:Ae,texSubImage2D:xe,texSubImage3D:je,compressedTexSubImage2D:Fe,compressedTexSubImage3D:Be,scissor:Ue,viewport:We,reset:Ct}}function Lc(i,e,t,n){const s=c_(n);switch(t){case fu:return i*e;case pu:return i*e;case mu:return i*e*2;case _u:return i*e/s.components*s.byteLength;case vl:return i*e/s.components*s.byteLength;case vu:return i*e*2/s.components*s.byteLength;case gl:return i*e*2/s.components*s.byteLength;case du:return i*e*3/s.components*s.byteLength;case ni:return i*e*4/s.components*s.byteLength;case xl:return i*e*4/s.components*s.byteLength;case ha:case fa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case da:case pa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case No:case Oo:return Math.max(i,16)*Math.max(e,8)/4;case Io:case Fo:return Math.max(i,8)*Math.max(e,8)/2;case Bo:case zo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case ko:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Vo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ho:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Go:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Wo:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Xo:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case qo:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Yo:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case $o:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Ko:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case jo:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Zo:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Jo:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Qo:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case el:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case ma:case tl:case nl:return Math.ceil(i/4)*Math.ceil(e/4)*16;case gu:case il:return Math.ceil(i/4)*Math.ceil(e/4)*8;case rl:case sl:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function c_(i){switch(i){case Ai:case cu:return{byteLength:1,components:1};case gs:case uu:case Ms:return{byteLength:2,components:1};case ml:case _l:return{byteLength:2,components:4};case cr:case pl:case wi:return{byteLength:4,components:1};case hu:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function u_(i,e,t,n,s,o,u){const c=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new lt,_=new WeakMap;let M;const S=new WeakMap;let b=!1;try{b=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function C(z,D){return b?new OffscreenCanvas(z,D):Ma("canvas")}function T(z,D,re){let be=1;const Ee=it(z);if((Ee.width>re||Ee.height>re)&&(be=re/Math.max(Ee.width,Ee.height)),be<1)if(typeof HTMLImageElement<"u"&&z instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&z instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&z instanceof ImageBitmap||typeof VideoFrame<"u"&&z instanceof VideoFrame){const xe=Math.floor(be*Ee.width),je=Math.floor(be*Ee.height);M===void 0&&(M=C(xe,je));const Fe=D?C(xe,je):M;return Fe.width=xe,Fe.height=je,Fe.getContext("2d").drawImage(z,0,0,xe,je),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Ee.width+"x"+Ee.height+") to ("+xe+"x"+je+")."),Fe}else return"data"in z&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Ee.width+"x"+Ee.height+")."),z;return z}function x(z){return z.generateMipmaps}function g(z){i.generateMipmap(z)}function k(z){return z.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:z.isWebGL3DRenderTarget?i.TEXTURE_3D:z.isWebGLArrayRenderTarget||z.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function F(z,D,re,be,Ee=!1){if(z!==null){if(i[z]!==void 0)return i[z];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+z+"'")}let xe=D;if(D===i.RED&&(re===i.FLOAT&&(xe=i.R32F),re===i.HALF_FLOAT&&(xe=i.R16F),re===i.UNSIGNED_BYTE&&(xe=i.R8)),D===i.RED_INTEGER&&(re===i.UNSIGNED_BYTE&&(xe=i.R8UI),re===i.UNSIGNED_SHORT&&(xe=i.R16UI),re===i.UNSIGNED_INT&&(xe=i.R32UI),re===i.BYTE&&(xe=i.R8I),re===i.SHORT&&(xe=i.R16I),re===i.INT&&(xe=i.R32I)),D===i.RG&&(re===i.FLOAT&&(xe=i.RG32F),re===i.HALF_FLOAT&&(xe=i.RG16F),re===i.UNSIGNED_BYTE&&(xe=i.RG8)),D===i.RG_INTEGER&&(re===i.UNSIGNED_BYTE&&(xe=i.RG8UI),re===i.UNSIGNED_SHORT&&(xe=i.RG16UI),re===i.UNSIGNED_INT&&(xe=i.RG32UI),re===i.BYTE&&(xe=i.RG8I),re===i.SHORT&&(xe=i.RG16I),re===i.INT&&(xe=i.RG32I)),D===i.RGB_INTEGER&&(re===i.UNSIGNED_BYTE&&(xe=i.RGB8UI),re===i.UNSIGNED_SHORT&&(xe=i.RGB16UI),re===i.UNSIGNED_INT&&(xe=i.RGB32UI),re===i.BYTE&&(xe=i.RGB8I),re===i.SHORT&&(xe=i.RGB16I),re===i.INT&&(xe=i.RGB32I)),D===i.RGBA_INTEGER&&(re===i.UNSIGNED_BYTE&&(xe=i.RGBA8UI),re===i.UNSIGNED_SHORT&&(xe=i.RGBA16UI),re===i.UNSIGNED_INT&&(xe=i.RGBA32UI),re===i.BYTE&&(xe=i.RGBA8I),re===i.SHORT&&(xe=i.RGBA16I),re===i.INT&&(xe=i.RGBA32I)),D===i.RGB&&re===i.UNSIGNED_INT_5_9_9_9_REV&&(xe=i.RGB9_E5),D===i.RGBA){const je=Ee?Ea:Nt.getTransfer(be);re===i.FLOAT&&(xe=i.RGBA32F),re===i.HALF_FLOAT&&(xe=i.RGBA16F),re===i.UNSIGNED_BYTE&&(xe=je===Gt?i.SRGB8_ALPHA8:i.RGBA8),re===i.UNSIGNED_SHORT_4_4_4_4&&(xe=i.RGBA4),re===i.UNSIGNED_SHORT_5_5_5_1&&(xe=i.RGB5_A1)}return(xe===i.R16F||xe===i.R32F||xe===i.RG16F||xe===i.RG32F||xe===i.RGBA16F||xe===i.RGBA32F)&&e.get("EXT_color_buffer_float"),xe}function A(z,D){let re;return z?D===null||D===cr||D===$r?re=i.DEPTH24_STENCIL8:D===wi?re=i.DEPTH32F_STENCIL8:D===gs&&(re=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):D===null||D===cr||D===$r?re=i.DEPTH_COMPONENT24:D===wi?re=i.DEPTH_COMPONENT32F:D===gs&&(re=i.DEPTH_COMPONENT16),re}function $(z,D){return x(z)===!0||z.isFramebufferTexture&&z.minFilter!==ii&&z.minFilter!==qn?Math.log2(Math.max(D.width,D.height))+1:z.mipmaps!==void 0&&z.mipmaps.length>0?z.mipmaps.length:z.isCompressedTexture&&Array.isArray(z.image)?D.mipmaps.length:1}function H(z){const D=z.target;D.removeEventListener("dispose",H),X(D),D.isVideoTexture&&_.delete(D)}function G(z){const D=z.target;D.removeEventListener("dispose",G),I(D)}function X(z){const D=n.get(z);if(D.__webglInit===void 0)return;const re=z.source,be=S.get(re);if(be){const Ee=be[D.__cacheKey];Ee.usedTimes--,Ee.usedTimes===0&&N(z),Object.keys(be).length===0&&S.delete(re)}n.remove(z)}function N(z){const D=n.get(z);i.deleteTexture(D.__webglTexture);const re=z.source,be=S.get(re);delete be[D.__cacheKey],u.memory.textures--}function I(z){const D=n.get(z);if(z.depthTexture&&(z.depthTexture.dispose(),n.remove(z.depthTexture)),z.isWebGLCubeRenderTarget)for(let be=0;be<6;be++){if(Array.isArray(D.__webglFramebuffer[be]))for(let Ee=0;Ee<D.__webglFramebuffer[be].length;Ee++)i.deleteFramebuffer(D.__webglFramebuffer[be][Ee]);else i.deleteFramebuffer(D.__webglFramebuffer[be]);D.__webglDepthbuffer&&i.deleteRenderbuffer(D.__webglDepthbuffer[be])}else{if(Array.isArray(D.__webglFramebuffer))for(let be=0;be<D.__webglFramebuffer.length;be++)i.deleteFramebuffer(D.__webglFramebuffer[be]);else i.deleteFramebuffer(D.__webglFramebuffer);if(D.__webglDepthbuffer&&i.deleteRenderbuffer(D.__webglDepthbuffer),D.__webglMultisampledFramebuffer&&i.deleteFramebuffer(D.__webglMultisampledFramebuffer),D.__webglColorRenderbuffer)for(let be=0;be<D.__webglColorRenderbuffer.length;be++)D.__webglColorRenderbuffer[be]&&i.deleteRenderbuffer(D.__webglColorRenderbuffer[be]);D.__webglDepthRenderbuffer&&i.deleteRenderbuffer(D.__webglDepthRenderbuffer)}const re=z.textures;for(let be=0,Ee=re.length;be<Ee;be++){const xe=n.get(re[be]);xe.__webglTexture&&(i.deleteTexture(xe.__webglTexture),u.memory.textures--),n.remove(re[be])}n.remove(z)}let W=0;function ue(){W=0}function ee(){const z=W;return z>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+z+" texture units while this GPU supports only "+s.maxTextures),W+=1,z}function se(z){const D=[];return D.push(z.wrapS),D.push(z.wrapT),D.push(z.wrapR||0),D.push(z.magFilter),D.push(z.minFilter),D.push(z.anisotropy),D.push(z.internalFormat),D.push(z.format),D.push(z.type),D.push(z.generateMipmaps),D.push(z.premultiplyAlpha),D.push(z.flipY),D.push(z.unpackAlignment),D.push(z.colorSpace),D.join()}function we(z,D){const re=n.get(z);if(z.isVideoTexture&&tt(z),z.isRenderTargetTexture===!1&&z.version>0&&re.__version!==z.version){const be=z.image;if(be===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(be.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{me(re,z,D);return}}t.bindTexture(i.TEXTURE_2D,re.__webglTexture,i.TEXTURE0+D)}function he(z,D){const re=n.get(z);if(z.version>0&&re.__version!==z.version){me(re,z,D);return}t.bindTexture(i.TEXTURE_2D_ARRAY,re.__webglTexture,i.TEXTURE0+D)}function Me(z,D){const re=n.get(z);if(z.version>0&&re.__version!==z.version){me(re,z,D);return}t.bindTexture(i.TEXTURE_3D,re.__webglTexture,i.TEXTURE0+D)}function fe(z,D){const re=n.get(z);if(z.version>0&&re.__version!==z.version){oe(re,z,D);return}t.bindTexture(i.TEXTURE_CUBE_MAP,re.__webglTexture,i.TEXTURE0+D)}const ve={[Do]:i.REPEAT,[or]:i.CLAMP_TO_EDGE,[Uo]:i.MIRRORED_REPEAT},He={[ii]:i.NEAREST,[Kh]:i.NEAREST_MIPMAP_NEAREST,[Ps]:i.NEAREST_MIPMAP_LINEAR,[qn]:i.LINEAR,[Da]:i.LINEAR_MIPMAP_NEAREST,[lr]:i.LINEAR_MIPMAP_LINEAR},Je={[Qh]:i.NEVER,[af]:i.ALWAYS,[ef]:i.LESS,[Mu]:i.LEQUAL,[tf]:i.EQUAL,[sf]:i.GEQUAL,[nf]:i.GREATER,[rf]:i.NOTEQUAL};function de(z,D){if(D.type===wi&&e.has("OES_texture_float_linear")===!1&&(D.magFilter===qn||D.magFilter===Da||D.magFilter===Ps||D.magFilter===lr||D.minFilter===qn||D.minFilter===Da||D.minFilter===Ps||D.minFilter===lr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(z,i.TEXTURE_WRAP_S,ve[D.wrapS]),i.texParameteri(z,i.TEXTURE_WRAP_T,ve[D.wrapT]),(z===i.TEXTURE_3D||z===i.TEXTURE_2D_ARRAY)&&i.texParameteri(z,i.TEXTURE_WRAP_R,ve[D.wrapR]),i.texParameteri(z,i.TEXTURE_MAG_FILTER,He[D.magFilter]),i.texParameteri(z,i.TEXTURE_MIN_FILTER,He[D.minFilter]),D.compareFunction&&(i.texParameteri(z,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(z,i.TEXTURE_COMPARE_FUNC,Je[D.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(D.magFilter===ii||D.minFilter!==Ps&&D.minFilter!==lr||D.type===wi&&e.has("OES_texture_float_linear")===!1)return;if(D.anisotropy>1||n.get(D).__currentAnisotropy){const re=e.get("EXT_texture_filter_anisotropic");i.texParameterf(z,re.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(D.anisotropy,s.getMaxAnisotropy())),n.get(D).__currentAnisotropy=D.anisotropy}}}function Ze(z,D){let re=!1;z.__webglInit===void 0&&(z.__webglInit=!0,D.addEventListener("dispose",H));const be=D.source;let Ee=S.get(be);Ee===void 0&&(Ee={},S.set(be,Ee));const xe=se(D);if(xe!==z.__cacheKey){Ee[xe]===void 0&&(Ee[xe]={texture:i.createTexture(),usedTimes:0},u.memory.textures++,re=!0),Ee[xe].usedTimes++;const je=Ee[z.__cacheKey];je!==void 0&&(Ee[z.__cacheKey].usedTimes--,je.usedTimes===0&&N(D)),z.__cacheKey=xe,z.__webglTexture=Ee[xe].texture}return re}function me(z,D,re){let be=i.TEXTURE_2D;(D.isDataArrayTexture||D.isCompressedArrayTexture)&&(be=i.TEXTURE_2D_ARRAY),D.isData3DTexture&&(be=i.TEXTURE_3D);const Ee=Ze(z,D),xe=D.source;t.bindTexture(be,z.__webglTexture,i.TEXTURE0+re);const je=n.get(xe);if(xe.version!==je.__version||Ee===!0){t.activeTexture(i.TEXTURE0+re);const Fe=Nt.getPrimaries(Nt.workingColorSpace),Be=D.colorSpace===Fi?null:Nt.getPrimaries(D.colorSpace),_t=D.colorSpace===Fi||Fe===Be?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,D.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,D.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t);let Ae=T(D.image,!1,s.maxTextureSize);Ae=Bt(D,Ae);const Ve=o.convert(D.format,D.colorSpace),nt=o.convert(D.type);let Ue=F(D.internalFormat,Ve,nt,D.colorSpace,D.isVideoTexture);de(be,D);let We;const rt=D.mipmaps,ut=D.isVideoTexture!==!0,Ct=je.__version===void 0||Ee===!0,Q=xe.dataReady,Ie=$(D,Ae);if(D.isDepthTexture)Ue=A(D.format===Kr,D.type),Ct&&(ut?t.texStorage2D(i.TEXTURE_2D,1,Ue,Ae.width,Ae.height):t.texImage2D(i.TEXTURE_2D,0,Ue,Ae.width,Ae.height,0,Ve,nt,null));else if(D.isDataTexture)if(rt.length>0){ut&&Ct&&t.texStorage2D(i.TEXTURE_2D,Ie,Ue,rt[0].width,rt[0].height);for(let pe=0,ge=rt.length;pe<ge;pe++)We=rt[pe],ut?Q&&t.texSubImage2D(i.TEXTURE_2D,pe,0,0,We.width,We.height,Ve,nt,We.data):t.texImage2D(i.TEXTURE_2D,pe,Ue,We.width,We.height,0,Ve,nt,We.data);D.generateMipmaps=!1}else ut?(Ct&&t.texStorage2D(i.TEXTURE_2D,Ie,Ue,Ae.width,Ae.height),Q&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ae.width,Ae.height,Ve,nt,Ae.data)):t.texImage2D(i.TEXTURE_2D,0,Ue,Ae.width,Ae.height,0,Ve,nt,Ae.data);else if(D.isCompressedTexture)if(D.isCompressedArrayTexture){ut&&Ct&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ie,Ue,rt[0].width,rt[0].height,Ae.depth);for(let pe=0,ge=rt.length;pe<ge;pe++)if(We=rt[pe],D.format!==ni)if(Ve!==null)if(ut){if(Q)if(D.layerUpdates.size>0){const v=Lc(We.width,We.height,D.format,D.type);for(const Se of D.layerUpdates){const ft=We.data.subarray(Se*v/We.data.BYTES_PER_ELEMENT,(Se+1)*v/We.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,pe,0,0,Se,We.width,We.height,1,Ve,ft)}D.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,pe,0,0,0,We.width,We.height,Ae.depth,Ve,We.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,pe,Ue,We.width,We.height,Ae.depth,0,We.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ut?Q&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,pe,0,0,0,We.width,We.height,Ae.depth,Ve,nt,We.data):t.texImage3D(i.TEXTURE_2D_ARRAY,pe,Ue,We.width,We.height,Ae.depth,0,Ve,nt,We.data)}else{ut&&Ct&&t.texStorage2D(i.TEXTURE_2D,Ie,Ue,rt[0].width,rt[0].height);for(let pe=0,ge=rt.length;pe<ge;pe++)We=rt[pe],D.format!==ni?Ve!==null?ut?Q&&t.compressedTexSubImage2D(i.TEXTURE_2D,pe,0,0,We.width,We.height,Ve,We.data):t.compressedTexImage2D(i.TEXTURE_2D,pe,Ue,We.width,We.height,0,We.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ut?Q&&t.texSubImage2D(i.TEXTURE_2D,pe,0,0,We.width,We.height,Ve,nt,We.data):t.texImage2D(i.TEXTURE_2D,pe,Ue,We.width,We.height,0,Ve,nt,We.data)}else if(D.isDataArrayTexture)if(ut){if(Ct&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ie,Ue,Ae.width,Ae.height,Ae.depth),Q)if(D.layerUpdates.size>0){const pe=Lc(Ae.width,Ae.height,D.format,D.type);for(const ge of D.layerUpdates){const v=Ae.data.subarray(ge*pe/Ae.data.BYTES_PER_ELEMENT,(ge+1)*pe/Ae.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ge,Ae.width,Ae.height,1,Ve,nt,v)}D.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Ae.width,Ae.height,Ae.depth,Ve,nt,Ae.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ue,Ae.width,Ae.height,Ae.depth,0,Ve,nt,Ae.data);else if(D.isData3DTexture)ut?(Ct&&t.texStorage3D(i.TEXTURE_3D,Ie,Ue,Ae.width,Ae.height,Ae.depth),Q&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Ae.width,Ae.height,Ae.depth,Ve,nt,Ae.data)):t.texImage3D(i.TEXTURE_3D,0,Ue,Ae.width,Ae.height,Ae.depth,0,Ve,nt,Ae.data);else if(D.isFramebufferTexture){if(Ct)if(ut)t.texStorage2D(i.TEXTURE_2D,Ie,Ue,Ae.width,Ae.height);else{let pe=Ae.width,ge=Ae.height;for(let v=0;v<Ie;v++)t.texImage2D(i.TEXTURE_2D,v,Ue,pe,ge,0,Ve,nt,null),pe>>=1,ge>>=1}}else if(rt.length>0){if(ut&&Ct){const pe=it(rt[0]);t.texStorage2D(i.TEXTURE_2D,Ie,Ue,pe.width,pe.height)}for(let pe=0,ge=rt.length;pe<ge;pe++)We=rt[pe],ut?Q&&t.texSubImage2D(i.TEXTURE_2D,pe,0,0,Ve,nt,We):t.texImage2D(i.TEXTURE_2D,pe,Ue,Ve,nt,We);D.generateMipmaps=!1}else if(ut){if(Ct){const pe=it(Ae);t.texStorage2D(i.TEXTURE_2D,Ie,Ue,pe.width,pe.height)}Q&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ve,nt,Ae)}else t.texImage2D(i.TEXTURE_2D,0,Ue,Ve,nt,Ae);x(D)&&g(be),je.__version=xe.version,D.onUpdate&&D.onUpdate(D)}z.__version=D.version}function oe(z,D,re){if(D.image.length!==6)return;const be=Ze(z,D),Ee=D.source;t.bindTexture(i.TEXTURE_CUBE_MAP,z.__webglTexture,i.TEXTURE0+re);const xe=n.get(Ee);if(Ee.version!==xe.__version||be===!0){t.activeTexture(i.TEXTURE0+re);const je=Nt.getPrimaries(Nt.workingColorSpace),Fe=D.colorSpace===Fi?null:Nt.getPrimaries(D.colorSpace),Be=D.colorSpace===Fi||je===Fe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,D.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,D.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Be);const _t=D.isCompressedTexture||D.image[0].isCompressedTexture,Ae=D.image[0]&&D.image[0].isDataTexture,Ve=[];for(let ge=0;ge<6;ge++)!_t&&!Ae?Ve[ge]=T(D.image[ge],!0,s.maxCubemapSize):Ve[ge]=Ae?D.image[ge].image:D.image[ge],Ve[ge]=Bt(D,Ve[ge]);const nt=Ve[0],Ue=o.convert(D.format,D.colorSpace),We=o.convert(D.type),rt=F(D.internalFormat,Ue,We,D.colorSpace),ut=D.isVideoTexture!==!0,Ct=xe.__version===void 0||be===!0,Q=Ee.dataReady;let Ie=$(D,nt);de(i.TEXTURE_CUBE_MAP,D);let pe;if(_t){ut&&Ct&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Ie,rt,nt.width,nt.height);for(let ge=0;ge<6;ge++){pe=Ve[ge].mipmaps;for(let v=0;v<pe.length;v++){const Se=pe[v];D.format!==ni?Ue!==null?ut?Q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v,0,0,Se.width,Se.height,Ue,Se.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v,rt,Se.width,Se.height,0,Se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):ut?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v,0,0,Se.width,Se.height,Ue,We,Se.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v,rt,Se.width,Se.height,0,Ue,We,Se.data)}}}else{if(pe=D.mipmaps,ut&&Ct){pe.length>0&&Ie++;const ge=it(Ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Ie,rt,ge.width,ge.height)}for(let ge=0;ge<6;ge++)if(Ae){ut?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,Ve[ge].width,Ve[ge].height,Ue,We,Ve[ge].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,rt,Ve[ge].width,Ve[ge].height,0,Ue,We,Ve[ge].data);for(let v=0;v<pe.length;v++){const ft=pe[v].image[ge].image;ut?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v+1,0,0,ft.width,ft.height,Ue,We,ft.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v+1,rt,ft.width,ft.height,0,Ue,We,ft.data)}}else{ut?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,0,0,Ue,We,Ve[ge]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,rt,Ue,We,Ve[ge]);for(let v=0;v<pe.length;v++){const Se=pe[v];ut?Q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v+1,0,0,Ue,We,Se.image[ge]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,v+1,rt,Ue,We,Se.image[ge])}}}x(D)&&g(i.TEXTURE_CUBE_MAP),xe.__version=Ee.version,D.onUpdate&&D.onUpdate(D)}z.__version=D.version}function Le(z,D,re,be,Ee,xe){const je=o.convert(re.format,re.colorSpace),Fe=o.convert(re.type),Be=F(re.internalFormat,je,Fe,re.colorSpace),_t=n.get(D),Ae=n.get(re);if(Ae.__renderTarget=D,!_t.__hasExternalTextures){const Ve=Math.max(1,D.width>>xe),nt=Math.max(1,D.height>>xe);Ee===i.TEXTURE_3D||Ee===i.TEXTURE_2D_ARRAY?t.texImage3D(Ee,xe,Be,Ve,nt,D.depth,0,je,Fe,null):t.texImage2D(Ee,xe,Be,Ve,nt,0,je,Fe,null)}t.bindFramebuffer(i.FRAMEBUFFER,z),yt(D)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,be,Ee,Ae.__webglTexture,0,xt(D)):(Ee===i.TEXTURE_2D||Ee>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Ee<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,be,Ee,Ae.__webglTexture,xe),t.bindFramebuffer(i.FRAMEBUFFER,null)}function De(z,D,re){if(i.bindRenderbuffer(i.RENDERBUFFER,z),D.depthBuffer){const be=D.depthTexture,Ee=be&&be.isDepthTexture?be.type:null,xe=A(D.stencilBuffer,Ee),je=D.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Fe=xt(D);yt(D)?c.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Fe,xe,D.width,D.height):re?i.renderbufferStorageMultisample(i.RENDERBUFFER,Fe,xe,D.width,D.height):i.renderbufferStorage(i.RENDERBUFFER,xe,D.width,D.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,je,i.RENDERBUFFER,z)}else{const be=D.textures;for(let Ee=0;Ee<be.length;Ee++){const xe=be[Ee],je=o.convert(xe.format,xe.colorSpace),Fe=o.convert(xe.type),Be=F(xe.internalFormat,je,Fe,xe.colorSpace),_t=xt(D);re&&yt(D)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,_t,Be,D.width,D.height):yt(D)?c.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,_t,Be,D.width,D.height):i.renderbufferStorage(i.RENDERBUFFER,Be,D.width,D.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ke(z,D){if(D&&D.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,z),!(D.depthTexture&&D.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const be=n.get(D.depthTexture);be.__renderTarget=D,(!be.__webglTexture||D.depthTexture.image.width!==D.width||D.depthTexture.image.height!==D.height)&&(D.depthTexture.image.width=D.width,D.depthTexture.image.height=D.height,D.depthTexture.needsUpdate=!0),we(D.depthTexture,0);const Ee=be.__webglTexture,xe=xt(D);if(D.depthTexture.format===Gr)yt(D)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Ee,0,xe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Ee,0);else if(D.depthTexture.format===Kr)yt(D)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Ee,0,xe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Ee,0);else throw new Error("Unknown depthTexture format")}function Ge(z){const D=n.get(z),re=z.isWebGLCubeRenderTarget===!0;if(D.__boundDepthTexture!==z.depthTexture){const be=z.depthTexture;if(D.__depthDisposeCallback&&D.__depthDisposeCallback(),be){const Ee=()=>{delete D.__boundDepthTexture,delete D.__depthDisposeCallback,be.removeEventListener("dispose",Ee)};be.addEventListener("dispose",Ee),D.__depthDisposeCallback=Ee}D.__boundDepthTexture=be}if(z.depthTexture&&!D.__autoAllocateDepthBuffer){if(re)throw new Error("target.depthTexture not supported in Cube render targets");ke(D.__webglFramebuffer,z)}else if(re){D.__webglDepthbuffer=[];for(let be=0;be<6;be++)if(t.bindFramebuffer(i.FRAMEBUFFER,D.__webglFramebuffer[be]),D.__webglDepthbuffer[be]===void 0)D.__webglDepthbuffer[be]=i.createRenderbuffer(),De(D.__webglDepthbuffer[be],z,!1);else{const Ee=z.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,xe=D.__webglDepthbuffer[be];i.bindRenderbuffer(i.RENDERBUFFER,xe),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ee,i.RENDERBUFFER,xe)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,D.__webglFramebuffer),D.__webglDepthbuffer===void 0)D.__webglDepthbuffer=i.createRenderbuffer(),De(D.__webglDepthbuffer,z,!1);else{const be=z.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ee=D.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,Ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,be,i.RENDERBUFFER,Ee)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function et(z,D,re){const be=n.get(z);D!==void 0&&Le(be.__webglFramebuffer,z,z.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),re!==void 0&&Ge(z)}function Dt(z){const D=z.texture,re=n.get(z),be=n.get(D);z.addEventListener("dispose",G);const Ee=z.textures,xe=z.isWebGLCubeRenderTarget===!0,je=Ee.length>1;if(je||(be.__webglTexture===void 0&&(be.__webglTexture=i.createTexture()),be.__version=D.version,u.memory.textures++),xe){re.__webglFramebuffer=[];for(let Fe=0;Fe<6;Fe++)if(D.mipmaps&&D.mipmaps.length>0){re.__webglFramebuffer[Fe]=[];for(let Be=0;Be<D.mipmaps.length;Be++)re.__webglFramebuffer[Fe][Be]=i.createFramebuffer()}else re.__webglFramebuffer[Fe]=i.createFramebuffer()}else{if(D.mipmaps&&D.mipmaps.length>0){re.__webglFramebuffer=[];for(let Fe=0;Fe<D.mipmaps.length;Fe++)re.__webglFramebuffer[Fe]=i.createFramebuffer()}else re.__webglFramebuffer=i.createFramebuffer();if(je)for(let Fe=0,Be=Ee.length;Fe<Be;Fe++){const _t=n.get(Ee[Fe]);_t.__webglTexture===void 0&&(_t.__webglTexture=i.createTexture(),u.memory.textures++)}if(z.samples>0&&yt(z)===!1){re.__webglMultisampledFramebuffer=i.createFramebuffer(),re.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,re.__webglMultisampledFramebuffer);for(let Fe=0;Fe<Ee.length;Fe++){const Be=Ee[Fe];re.__webglColorRenderbuffer[Fe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,re.__webglColorRenderbuffer[Fe]);const _t=o.convert(Be.format,Be.colorSpace),Ae=o.convert(Be.type),Ve=F(Be.internalFormat,_t,Ae,Be.colorSpace,z.isXRRenderTarget===!0),nt=xt(z);i.renderbufferStorageMultisample(i.RENDERBUFFER,nt,Ve,z.width,z.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Fe,i.RENDERBUFFER,re.__webglColorRenderbuffer[Fe])}i.bindRenderbuffer(i.RENDERBUFFER,null),z.depthBuffer&&(re.__webglDepthRenderbuffer=i.createRenderbuffer(),De(re.__webglDepthRenderbuffer,z,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(xe){t.bindTexture(i.TEXTURE_CUBE_MAP,be.__webglTexture),de(i.TEXTURE_CUBE_MAP,D);for(let Fe=0;Fe<6;Fe++)if(D.mipmaps&&D.mipmaps.length>0)for(let Be=0;Be<D.mipmaps.length;Be++)Le(re.__webglFramebuffer[Fe][Be],z,D,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Fe,Be);else Le(re.__webglFramebuffer[Fe],z,D,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Fe,0);x(D)&&g(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(je){for(let Fe=0,Be=Ee.length;Fe<Be;Fe++){const _t=Ee[Fe],Ae=n.get(_t);t.bindTexture(i.TEXTURE_2D,Ae.__webglTexture),de(i.TEXTURE_2D,_t),Le(re.__webglFramebuffer,z,_t,i.COLOR_ATTACHMENT0+Fe,i.TEXTURE_2D,0),x(_t)&&g(i.TEXTURE_2D)}t.unbindTexture()}else{let Fe=i.TEXTURE_2D;if((z.isWebGL3DRenderTarget||z.isWebGLArrayRenderTarget)&&(Fe=z.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Fe,be.__webglTexture),de(Fe,D),D.mipmaps&&D.mipmaps.length>0)for(let Be=0;Be<D.mipmaps.length;Be++)Le(re.__webglFramebuffer[Be],z,D,i.COLOR_ATTACHMENT0,Fe,Be);else Le(re.__webglFramebuffer,z,D,i.COLOR_ATTACHMENT0,Fe,0);x(D)&&g(Fe),t.unbindTexture()}z.depthBuffer&&Ge(z)}function Tt(z){const D=z.textures;for(let re=0,be=D.length;re<be;re++){const Ee=D[re];if(x(Ee)){const xe=k(z),je=n.get(Ee).__webglTexture;t.bindTexture(xe,je),g(xe),t.unbindTexture()}}}const qt=[],j=[];function Yt(z){if(z.samples>0){if(yt(z)===!1){const D=z.textures,re=z.width,be=z.height;let Ee=i.COLOR_BUFFER_BIT;const xe=z.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,je=n.get(z),Fe=D.length>1;if(Fe)for(let Be=0;Be<D.length;Be++)t.bindFramebuffer(i.FRAMEBUFFER,je.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,je.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,je.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,je.__webglFramebuffer);for(let Be=0;Be<D.length;Be++){if(z.resolveDepthBuffer&&(z.depthBuffer&&(Ee|=i.DEPTH_BUFFER_BIT),z.stencilBuffer&&z.resolveStencilBuffer&&(Ee|=i.STENCIL_BUFFER_BIT)),Fe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,je.__webglColorRenderbuffer[Be]);const _t=n.get(D[Be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_t,0)}i.blitFramebuffer(0,0,re,be,0,0,re,be,Ee,i.NEAREST),d===!0&&(qt.length=0,j.length=0,qt.push(i.COLOR_ATTACHMENT0+Be),z.depthBuffer&&z.resolveDepthBuffer===!1&&(qt.push(xe),j.push(xe),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,j)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,qt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Fe)for(let Be=0;Be<D.length;Be++){t.bindFramebuffer(i.FRAMEBUFFER,je.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.RENDERBUFFER,je.__webglColorRenderbuffer[Be]);const _t=n.get(D[Be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,je.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.TEXTURE_2D,_t,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,je.__webglMultisampledFramebuffer)}else if(z.depthBuffer&&z.resolveDepthBuffer===!1&&d){const D=z.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[D])}}}function xt(z){return Math.min(s.maxSamples,z.samples)}function yt(z){const D=n.get(z);return z.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&D.__useRenderToTexture!==!1}function tt(z){const D=u.render.frame;_.get(z)!==D&&(_.set(z,D),z.update())}function Bt(z,D){const re=z.colorSpace,be=z.format,Ee=z.type;return z.isCompressedTexture===!0||z.isVideoTexture===!0||re!==Zr&&re!==Fi&&(Nt.getTransfer(re)===Gt?(be!==ni||Ee!==Ai)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",re)),D}function it(z){return typeof HTMLImageElement<"u"&&z instanceof HTMLImageElement?(p.width=z.naturalWidth||z.width,p.height=z.naturalHeight||z.height):typeof VideoFrame<"u"&&z instanceof VideoFrame?(p.width=z.displayWidth,p.height=z.displayHeight):(p.width=z.width,p.height=z.height),p}this.allocateTextureUnit=ee,this.resetTextureUnits=ue,this.setTexture2D=we,this.setTexture2DArray=he,this.setTexture3D=Me,this.setTextureCube=fe,this.rebindTextures=et,this.setupRenderTarget=Dt,this.updateRenderTargetMipmap=Tt,this.updateMultisampleRenderTarget=Yt,this.setupDepthRenderbuffer=Ge,this.setupFrameBufferTexture=Le,this.useMultisampledRTT=yt}function h_(i,e){function t(n,s=Fi){let o;const u=Nt.getTransfer(s);if(n===Ai)return i.UNSIGNED_BYTE;if(n===ml)return i.UNSIGNED_SHORT_4_4_4_4;if(n===_l)return i.UNSIGNED_SHORT_5_5_5_1;if(n===hu)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===cu)return i.BYTE;if(n===uu)return i.SHORT;if(n===gs)return i.UNSIGNED_SHORT;if(n===pl)return i.INT;if(n===cr)return i.UNSIGNED_INT;if(n===wi)return i.FLOAT;if(n===Ms)return i.HALF_FLOAT;if(n===fu)return i.ALPHA;if(n===du)return i.RGB;if(n===ni)return i.RGBA;if(n===pu)return i.LUMINANCE;if(n===mu)return i.LUMINANCE_ALPHA;if(n===Gr)return i.DEPTH_COMPONENT;if(n===Kr)return i.DEPTH_STENCIL;if(n===_u)return i.RED;if(n===vl)return i.RED_INTEGER;if(n===vu)return i.RG;if(n===gl)return i.RG_INTEGER;if(n===xl)return i.RGBA_INTEGER;if(n===ha||n===fa||n===da||n===pa)if(u===Gt)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(n===ha)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===da)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===pa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(n===ha)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fa)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===da)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===pa)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Io||n===No||n===Fo||n===Oo)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(n===Io)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===No)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Fo)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Oo)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Bo||n===zo||n===ko)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(n===Bo||n===zo)return u===Gt?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(n===ko)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Vo||n===Ho||n===Go||n===Wo||n===Xo||n===qo||n===Yo||n===$o||n===Ko||n===jo||n===Zo||n===Jo||n===Qo||n===el)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(n===Vo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ho)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Go)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Wo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Xo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===qo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Yo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===$o)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ko)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===jo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Zo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Jo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Qo)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===el)return u===Gt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ma||n===tl||n===nl)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(n===ma)return u===Gt?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===tl)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===nl)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===gu||n===il||n===rl||n===sl)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(n===ma)return o.COMPRESSED_RED_RGTC1_EXT;if(n===il)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===rl)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===sl)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===$r?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class f_ extends Wn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class An extends on{constructor(){super(),this.isGroup=!0,this.type="Group"}}const d_={type:"move"};class ao{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new An,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new An,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Z,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Z),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new An,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Z,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Z),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,o=null,u=null;const c=this._targetRay,d=this._grip,p=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(p&&e.hand){u=!0;for(const T of e.hand.values()){const x=t.getJointPose(T,n),g=this._getHandJoint(p,T);x!==null&&(g.matrix.fromArray(x.transform.matrix),g.matrix.decompose(g.position,g.rotation,g.scale),g.matrixWorldNeedsUpdate=!0,g.jointRadius=x.radius),g.visible=x!==null}const _=p.joints["index-finger-tip"],M=p.joints["thumb-tip"],S=_.position.distanceTo(M.position),b=.02,C=.005;p.inputState.pinching&&S>b+C?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&S<=b-C&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else d!==null&&e.gripSpace&&(o=t.getPose(e.gripSpace,n),o!==null&&(d.matrix.fromArray(o.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,o.linearVelocity?(d.hasLinearVelocity=!0,d.linearVelocity.copy(o.linearVelocity)):d.hasLinearVelocity=!1,o.angularVelocity?(d.hasAngularVelocity=!0,d.angularVelocity.copy(o.angularVelocity)):d.hasAngularVelocity=!1));c!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&o!==null&&(s=o),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1,this.dispatchEvent(d_)))}return c!==null&&(c.visible=s!==null),d!==null&&(d.visible=o!==null),p!==null&&(p.visible=u!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new An;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const p_=`
void main() {
